...
\NormalTok{lm_sleep_filtered <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ msleep }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(name }\OperatorTok{!=}\StringTok{ 'African elephant'}\NormalTok{), bodywt }\OperatorTok{~}\StringTok{ }\NormalTok{awake)}
\NormalTok{msleep }\OperatorTok{%>%}
