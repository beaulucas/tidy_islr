...
We will opt for the `readr` package instead of base R. Take a look at this subsection of *r4ds* for reasons why: 
[*11.2.1 Compared to base R*](http://r4ds.had.co.nz/data-import.html)

```{r}
# generate tsv data to read in
...
generic_company_tibble
write_tsv("generic_company_tibble")
```
